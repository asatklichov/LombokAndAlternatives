...
public class PersonTest {
	private static Adam JOHN = Adam.builder().firstName("John").lastName("Doe").age(30).build();
	private static Adam JANE = Adam.builder().firstName("Jane").lastName("Doe").age(30).build();

	@Test
	public void testEquals() throws Exception {
		Adam JOHN_COPY = JOHN.toBuilder().build();
