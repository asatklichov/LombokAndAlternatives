...
public class App implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 */
		/*
		 * ImmutablePerson john =
		 * ImmutablePerson.builder().age(42).firstName("Adam").lastName("John").build();
		 * System.out.println(john);
		 * 
		 * final ImmutablePerson p =
		 * ImmutablePerson.builder().age(31).firstName("Ola").lastName("Ili").build();
		 ...
		 * ImmutablePerson imCpy = ImmutablePerson.copyOf(p); System.out.println(imCpy);
		 * 
		 *//**
		 ...
		 * 
		 *//**
			 * @Value.Default annotation. No need AGE. NO ERROR - some of required
		 ...
		 *//**
			 ...
			 */
		/*
		 * ImmutablePerson4 j4a =
		 * ImmutablePerson4.builder().name("John").age(42).auxiliaryField("Value1") //
		 * excluded from // those methods .build();
		 * 
		 * ImmutablePerson4 j4b =
		 * ImmutablePerson4.builder().name("John").age(42).auxiliaryField("Value2") //
		 * excluded from // those methods .build();
		 * 
		 ...
		 *//**
			 ...
			 *//*
				 * ImmutablePerson5 j5 =
				 * ImmutablePerson5.builder().age(23).name("John").build();
